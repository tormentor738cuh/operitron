    ...
    <div className="space-y-5">
      ...
      <section>
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          {toolCards.map((tool) => <ToolCard key={tool.id} tool={tool} onClick={() => setActiveTool(tool.id)} compact />)}
        </div>
      </section>
    </div>
  );
