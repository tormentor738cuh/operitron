...
const initialProjects = [
  {
    ...
    name: "Sample Flip",
    type: "Fix & Flip",
    address: "100 Example Ave, Denver, CO",
    arv: 425000,
    profit: 74500,
    purchase: 286000,
    repairs: 46000,
  ...
  {
    id: 2,
    name: "Demo Rental Property",
    type: "Rental Analysis",
    address: "250 Sample St, Raleigh, NC",
    arv: 235000,
    profit: 13000,
    purchase: 194000,
    repairs: 15500,
  ...
  },
  {
    ...
    address: "Lot 12 Builder Way, Austin, TX",
    arv: 589000,
    profit: 92000,
    purchase: 372000,
    repairs: 82000,
      ...
      <GlassPanel>
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-black text-white sm:text-4xl">Summit Builders</h2>
    ...
    return (
      <div className="mx-auto mt-6 max-w-xl rounded-[2rem] border border-white/10 bg-white/[.035] p-5 shadow-2xl shadow-black/30 sm:p-7">
        ...
        <label className="mt-6 block">
          ...
          <input autoFocus value={projectName} onChange={(event) => setProjectName(event.target.value)} onKeyDown={(event) => { if (event.key === "Enter") createProject(); }} className="field text-base" placeholder={isEs ? "Ej. Remodelacion de muestra" : "Example: Sample Renovation"} />
        </label>
...
function BudgetEstimator({ language = "en", project }) {
  ...
  const [spec, setSpec] = useState({ type: "New Construction", city: "Denver", sqft: "2,000", foundation: "Slab", finish: "Standard" });
  ...
  const [quotes, setQuotes] = useState([
    ...
    { trade: "Framing", vendor: "Blue Ridge Framing", price: 42000, scope: "Labor and lumber package", status: "Approved" },
